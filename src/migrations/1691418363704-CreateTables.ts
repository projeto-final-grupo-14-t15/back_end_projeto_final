...
export class CreateTables1691418363704 implements MigrationInterface {
    name = 'CreateTables1691418363704'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" SERIAL NOT NULL, "mark" character varying(55) NOT NULL, "description" character varying(255) NOT NULL, "model" character varying(55) NOT NULL, "year" character varying(4) NOT NULL, "km" character varying(55) NOT NULL, "fuel" character varying(55) NOT NULL, "color" character varying(55) NOT NULL, "price_table" character varying(55) NOT NULL, "price" character varying(55) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updated_at" date NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
