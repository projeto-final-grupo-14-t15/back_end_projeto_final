...
export class CreateTables1691689838354 implements MigrationInterface {
    name = 'CreateTables1691689838354'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" SERIAL NOT NULL, "brand" character varying(55) NOT NULL, "description" character varying(255) NOT NULL, "model" character varying(55) NOT NULL, "year" character varying(4) NOT NULL, "km" character varying(6) NOT NULL, "fuel" character varying(55) NOT NULL, "color" character varying(55) NOT NULL, "higher_than_fipe" boolean NOT NULL, "price" character varying(10) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updated_at" date NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "email" character varying(155) NOT NULL, "password" character varying(255) NOT NULL, "isAdmin" boolean NOT NULL DEFAULT false, "description" character varying(255) NOT NULL, "telephone" character varying(25) NOT NULL, "cpf" character varying(15) NOT NULL, "date_of_birth" date NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updated_at" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "addresses" ("id" SERIAL NOT NULL, "cep" character varying(15) NOT NULL, "state" character varying(55) NOT NULL, "city" character varying(55) NOT NULL, "street" character varying(55) NOT NULL, "complement" character varying(55) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updated_at" date NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "REL_95c93a584de49f0b0e13f75363" UNIQUE ("userId"), CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
